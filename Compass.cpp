...
static int toBoundedDegrees(int headingSteps, int stepSize)
{
	...
	return (unboundedDegrees >= 0)
		...
		: Compass::MAX_DEGREES - (-unboundedDegrees % Compass::MAX_DEGREES);
}

Compass::Compass(int initialHeadingSteps, StepsOf90_t tag)
	: m_headingDegrees(toBoundedDegrees(initialHeadingSteps, 90))
{
}

Compass::Compass(int initialHeading, InDegrees_t tag)
